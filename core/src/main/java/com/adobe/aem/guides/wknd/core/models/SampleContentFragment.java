...
public class SampleContentFragment {
	...
	public static final String CF_PATH = "/content/dam/wknd/content-fragment/en/author-detailes";
	...
	public String getTitle() {
		return contentFragment.map(cf -> cf.getElement("namecf")).map(ContentElement::getContent)
				.orElse(StringUtils.EMPTY);
	}
	public String getDescription() {
		return contentFragment.map(cf -> cf.getElement("descriptioncf")).map(ContentElement::getContent)
				.orElse(StringUtils.EMPTY);
	}
/*
